        ...
        <Grid lg={12} md={12} item container>
          <Grid item lg={12}>
            <Stack direction="row" sx={{ p: 2 }}>
              ...
              <Grid lg={3}>
                <Stack direction="row" >
                  <ReplyIcon style={{ color: indigo[200] }} /><ReplyAllIcon style={{ color: indigo[200] }} /><ShortcutOutlinedIcon style={{ color: indigo[200] }} />...
                </Stack>
          ...
          <Box sx={{ p: 6,justifyContent:"center",alignItems:"center"}}>
            <Grid item lg={12} >
          ...
          <Grid item lg={12} mb={2}  container>
            <Grid lg={1}></Grid>
            <Grid lg={7} sx={{m:1}}>
              <Button variant="outlined" color="inherit" sx={{ borderRadius: 10, color: grey ,m:1}}>
                {" "}
                <ReplyIcon /> Reply
              </Button>
              <Button variant="outlined" color="inherit" sx={{ borderRadius: 10, color: grey }}>
